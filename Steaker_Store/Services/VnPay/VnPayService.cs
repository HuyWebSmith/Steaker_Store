...
namespace Steaker_Store.Services.VnPay
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePaymentUrl(PaymentInformationModel model, HttpContext context, string orderCode)
        {
            ...
            long amountLong = (long)(amountDecimal * 100); // Convert to cents if needed
